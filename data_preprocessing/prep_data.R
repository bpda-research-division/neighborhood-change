...
APP_CONFIG <- list(
  ## 2010 tracts ------
  "tracts" = list(geoms = tract2010_geoms, generalTopics = list( 
    ### Businesses ----
    "Businesses" = list(topics = list(
      #### num of sm. bus. loans ------
  ...
  ## 2020 tracts ------
  "census tracts" = list(geoms = tract2020_geoms, generalTopics = list(
    ### Demographics -----
    "Demographics" = list(topics = list(
      #### pop by sex -----
      "Population" = list(
  ...
  ## neighborhoods -----
  "neighborhoods" = list(geoms = neigh2020_geoms, generalTopics = list(
    ### Demographics -----
    "Demographics" = list(topics=list(
      #### pop by sex ----
      "Population" = list(
...
#   for (generalTopic in geo_type$generalTopics) {
#     for (topic in generalTopic$topics) {
#       prep_data(topic)
#     }
#   }
# }
